...
def is_swap(score0, score1):
    ...
    if score0 <= 1 or score1 <= 1:
        return False
    return not (score0 % score1 and score1 % score0)
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        elif diff > previous_high and diff > 1:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for i in range(10):
        ...
        average = averaged_roll_dice(i+1, dice)
        if average > highest:
            highest = average
            target = i + 1
    return target
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(score, opponent_score) and score < opponent_score:
        return 0
    elif free_bacon(opponent_score) >= margin and not is_swap(score, opponent_score):
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
